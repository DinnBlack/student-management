...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btListStudents = view.findViewById(R.id.btListStudents);
        btListStudents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(getContext(), ListStudentsActivity.class);
                startActivity(myIntent);
            }
        });

        btListAccounts = view.findViewById(R.id.btListAccounts);
        btListAccounts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(getContext(), ListAccountsActivity.class);
                startActivity(myIntent);
            }
        });
        return view;
